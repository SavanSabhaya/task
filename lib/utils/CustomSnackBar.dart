...
class CustomSnackBar extends StatefulWidget {
  ...
  const CustomSnackBar.error({
    ...
    this.iconPositionTop = -10,
    this.iconPositionLeft = -8,
    this.backgroundColor = ColorConstants.errorColor,
    this.boxShadow = kDefaultBoxShadow,
    this.borderRadius = kDefaultBorderRadius,
    this.textScaleFactor = 1.0,
    this.textAlign = TextAlign.start,
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: widget.backgroundColor, borderRadius: const BorderRadius.all(Radius.circular(50)), border: Border.all(color: Colors.white)),
              child: const Icon(
                Icons.close,
                size: 24,
                color: Colors.white,
